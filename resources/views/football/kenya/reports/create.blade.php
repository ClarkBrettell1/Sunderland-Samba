...
<div class="d-flex flex-column page-size ">
    <div clas="mssg"></div>
    <form class="d-flex flex-column create-form px-5 py-3" style="background: white;" action="/football/sunderland/reports" method="POST" enctype="multipart/form-data">
        ...
        <div class="input-group mb-3 p-0">
            ...
            <input class="form-control" name="title" id="title" placeholder="Example: Samba Vs Yav" aria-label="Fixture Title" required aria-describedby="basic-addon1">
        </div>
        ...
        <div class="input-group mb-3 p-0 d-flex" style="flex-wrap:nowrap; align-items: baseline;">
            ...
            <div class="datepicker date input-group p-1 d-flex" style="height:38px; align-items: baseline;">
                <input class="p-1 mb-3" id="date" name="date" required>
        ...
        <div class="input-group mb-3">
          ...
          <div class="form-group">
              ...
              <input class="p-1 m-1" type="file" id="img" name="img" required>
          </div>

          <div class="form-group">
            <label for="paragraph_1">First Paragraph: ( Recommend typing this up and copying pasting in )</label>
            <textarea class="form-control" rows="10" name="paragraph_1" id="paragraph_1" required></textarea>
          </div>
        ...
        <input class="btn btn-primary px-3 mx-auto my-2" type="submit" value="Add Match Report">
    </form>
</div>
<script>
