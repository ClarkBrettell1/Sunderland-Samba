...
<div class="d-flex flex-column page-size p-2">
    ...
    <div clas="mssg"></div>
    <form class="d-flex flex-column create-form p-3" action="/football/sunderland/reports" method="POST" enctype="multipart/form-data">
        @csrf
        <label for="title">Fixture Name</label>
        <input class="p-1 m-1" name="title" id="title">

        <label for="date">Fixture Date</label>
        <div class="datepicker date input-group p-1">
            <input class="p-1 m-1" id="date" name="date">
        ...
        <input class="p-1 m-1" name="home" id="home">

        <label for="home_goals">Home Goals</label>
        <input class="p-1 m-1" name="home_goals" id="home_goals">

        <label for="away_goals">Away Goals</label>
        <input class="p-1 m-1" name="away_goals" id="away_goals">
        ...
        <input class="btn btn-info px-3 mx-auto my-2" type="submit" value="Add Match Report">
    </form>
</div>
@endsection
